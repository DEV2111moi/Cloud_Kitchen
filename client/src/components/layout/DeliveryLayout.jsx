...
const DeliveryLayout = () => {
  ...
  const navItems = [
    { to: '/delivery', icon: HiOutlineViewGrid, label: 'Delivery Tasks' },
  ];
  ...
  return (
    <div className="min-h-screen bg-surface-50 flex">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 z-50 h-full w-[260px] bg-slate-900 text-white flex flex-col transition-transform duration-300 ease-in-out lg:translate-x-0 ${
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-5 border-b border-white/10">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h1 className="text-sm font-bold tracking-tight text-white">Cloud Delivery</h1>
              <p className="text-[10px] text-white/50 font-semibold uppercase">Partner Portal</p>
            </div>
          </div>
        ...
        <div className="border-t border-white/10 p-4">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div className="min-w-0">
              ...
              <span className="inline-block px-1.5 py-0.5 rounded text-[9px] font-bold bg-orange-500/20 text-orange-400 uppercase tracking-wider">
                Approved Partner
              </span>
            </div>
          </div>
