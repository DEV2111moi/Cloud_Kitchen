  ...
  try {
    ...
    const homeCooks = await HomeCook.create([
      ...
      },
      {
        ...
        phone: '9876543212',
        password: 'cook123',
        address: { street: '78 Law Garden', city: 'Ahmedabad', state: 'Gujarat', pincode: '380006' },
      ...
      },
      {
        ...
        phone: '9876543213',
        password: 'cook123',
        address: { street: '22 Koramangala', city: 'Bangalore', state: 'Karnataka', pincode: '560034' },
      ...
      },
      {
        ...
        phone: '9876543214',
        password: 'cook123',
        address: { street: '56 Charminar', city: 'Hyderabad', state: 'Telangana', pincode: '500002' },
      ...
      },
      {
        ...
        phone: '9876543215',
        password: 'cook123',
        address: { street: '33 Banjara Hills', city: 'Hyderabad', state: 'Telangana', pincode: '500034' },
      ...
      },
      {
        ...
        phone: '9876543216',
        password: 'cook123',
        address: { street: '11 Lajpat Nagar', city: 'Delhi', state: 'Delhi', pincode: '110024' },
      ...
      },
      {
        ...
        phone: '9876543217',
        password: 'cook123',
        address: { street: '67 Marine Drive', city: 'Kochi', state: 'Kerala', pincode: '682001' },
    ...
    const deliveryPartners = await DeliveryPartner.insertMany([
      ...
      },
      {
        ...
        status: 'pending',
        isAvailable: true,
        documents: { drivingLicense: 'DL-34567', idProof: 'AADHAAR-ZZZZ', vehicleRC: 'RC-34567', verified: false },
        totalDeliveries: 0,
        rating: 0,
        earnings: 0,
      },
      ...
      },
      {
        ...
        phone: '7654321005',
        vehicleType: 'scooter',
        vehicleNumber: 'KA-05-KL-2345',
        status: 'pending',
        isAvailable: true,
        documents: { drivingLicense: 'DL-67890', idProof: 'AADHAAR-UUUU', vehicleRC: 'RC-67890', verified: false },
        totalDeliveries: 0,
        rating: 0,
        earnings: 0,
      },
